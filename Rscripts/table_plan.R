table_plan <- drake_plan(
  ...
  hinder.table = tribble(
    ...
    "Collaborators not using OS", "When collaborators are wary or do not use OS, it makes it harder for me to use OS. This means I don't have opportunities to use OS.","Fellow scientists have been a bit skeptical about the idea of “giving away“ their data.",
    "Fear of critique", "Afraid of people being overly critical of my work because it's available.", "Fear of data being used to show that my work is wrong and flawed.",
    "Legal concerns", "Is concerned about either intellectual property, patent law, or data management law, such as GDPR not allowing them to share data.", "My data is not mine but rather has been funded and collected by a country's regulatory agency. Otherwise I would freely make it available.",
    "Insufficient knowledge", "Don't know how to use OS. Afraid of trying OS platforms because I don't know how to use them.", "Initially it was a lack of knowledge on how and where I could share code and data.",
    ...
    #"Other/Vague", "Unclear what they mean, but they are saying something that means something.",
    "Nothing", "Specifically states that there is nothing hindering them.", NA,
  ),
  ...
  help.table = tribble(
    ...
    "Social support", "Encouragements or other support from your peers. This includes having a local or online community and the culture or movement around open science.", "Working with people who are collaborative and like minded.",
